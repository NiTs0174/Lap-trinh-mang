...
public class SapXepThread {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Chuoi truoc SX: " + Arrays.toString(array));
        ...
        System.out.println("Da SX: " + Arrays.toString(array));
    ...
    private static int[] createArray(){
        ...
        for (int i = 0; i < ARRAY_SIZE; i++) {
            array[i] = (int)(Math.random() * 1000000); // Generate random numbers between 0 and 400     
        }
        return array;
    }
