...
public class server {
    //khai bao các hang trong giao thục giao tiếp
    ...
    //ham doi chuoi giao tiếp thanh hang cho de xu ly 
    ...
    //thiet lap port giao tiep cua ung dung, FTP co port la 20 và 21 
    //vi du chon port 10000
    public static final int PORT= 10000;
    public static void main(String[] args) {
        //gia su co user, pass, path
        //sinh vien thay 1 user nay bang cách truy xuat co so du lieu // cac user đa tạo ra o buoc 1 do chuong trinh quan ly user 
        String userA="tu";
        String passA="tu"; 
        String path="C:/"; 
        ServerSocket s;
            ...
            while (true) {
                ...
                while (lap){
                    ...
                    case DANGNHAP:
                        ...
                        if (user.equals(user) && pass.equals(passA)) { 
                                pw.println(DANGNHAPTHANHCONG);
                            //mo thu mục len goi ve cho client
                    ...
                    case UPLOAD:
                        ...
                        try{
                            ...
                            //va gan ten tap tin tu client vào tuong ung
    ...
    static void traThuMucClient(String path, PrintWriter out) {
        try{
            ...
            try{
                ...
                System.out.println("da la de tap tin"); 
